...
if("TRUE" STREQUAL "TRUE")
  set(sigverse_turtlebot3_laser_distance_sensor_SOURCE_PREFIX /home/kamerider/catkin_ws/src/simulation-interactive_clean up/sigverse_ros_package/samples/turtlebot3/laser_distance_sensor)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sigverse_turtlebot3_laser_distance_sensor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kamerider/catkin_ws/src/simulation-interactive_clean up/sigverse_ros_package/samples/turtlebot3/laser_distance_sensor/${idir}'.  ${_report}")
    endif()
