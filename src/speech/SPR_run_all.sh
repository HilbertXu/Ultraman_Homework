...
gnome-terminal -x bash -c " pocketsphinx_continuous -inmic yes -dict ~/catkin_ws/src/speech/voice_library/4507.dic -lm ~/catkin_ws/src/speech/voice_library/4507.lm"
